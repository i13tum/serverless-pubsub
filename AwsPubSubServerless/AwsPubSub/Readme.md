...
Once you have edited your template and code you can use the following command lines to deploy your application from the command line (these examples assume the project name is *AwsPubSub*):
...
Execute unit tests
```
    cd "AwsPubSub/test/AwsPubSub.Tests"
    dotnet test
```

Deploy application
```
    cd "AwsPubSub/src/AwsPubSub"
